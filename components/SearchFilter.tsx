      ...
      <div className="container-tesla py-6">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <motion.button
            ...
            className="flex items-center space-x-2 px-6 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors duration-300"
          >
        ...
        >
          <div className="mt-6 p-6 bg-gray-50 rounded-xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-tesla-black">Bộ lọc nâng cao</h3>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFilterChange('batteryHealth', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-tesla-black/20 focus:border-tesla-black transition-all duration-300"
                >
