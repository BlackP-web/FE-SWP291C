  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const msg =
        ...
        (err?.code === 'ECONNABORTED' ? 'Máy chủ không phản hồi, thử lại sau.' : 'Đăng ký thất bại. Vui lòng kiểm tra thông tin.')
      setError(msg)
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-gray-50 px-4">
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-3xl shadow-2xl p-6">
        <h1 className="text-2xl font-light text-tesla-black mb-6 text-center">Đăng ký</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-gray-700 font-medium">Đăng ký bằng SĐT</span>
            </button>
          </div>

          <p className="text-center text-sm text-gray-600">
            Đã có tài khoản? <a href="/login" className="text-tesla-black hover:text-tesla-dark-gray">Đăng nhập</a>
          </p>
        </form>
      </div>
    </div>
