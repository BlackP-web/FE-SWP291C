        ...
        >
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Bắt đầu hành trình mua bán xe điện của bạn với nền tảng uy tín
              nhất Việt Nam.
            </p>
          </div>
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    className="text-gray-800 w-full pl-14 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm font-medium"
                    required
                  />
                </div>
              </motion.div>
              ...
              >
                <div className="relative">
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleInputChange}
                    className="text-gray-800 w-full pl-14 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm font-medium appearance-none cursor-pointer"
                  >
