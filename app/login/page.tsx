  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const msg =
        ...
        (err?.code === 'ECONNABORTED' ? 'Máy chủ không phản hồi, thử lại sau.' : 'Đăng nhập thất bại. Vui lòng kiểm tra thông tin.')
      setError(msg)
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-gray-50 px-4">
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-3xl shadow-2xl p-6">
        <h1 className="text-2xl font-light text-tesla-black mb-6 text-center">Đăng nhập</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-gray-700 font-medium">Đăng nhập bằng SĐT</span>
            </button>
          </div>

          <p className="text-center text-sm text-gray-600">
            Chưa có tài khoản? <a href="/register" className="text-tesla-black hover:text-tesla-dark-gray font-medium">Đăng ký</a>
          </p>
        </form>
      </div>
    </div>
